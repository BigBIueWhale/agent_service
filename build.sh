...
PRESERVED_SETTINGS_SHA256="$(lock_value '.agent.preserved_settings_sha256')"
...
readonly SETTINGS_SHA256 PRESERVED_SETTINGS_SHA256 INSTRUCTIONS_SHA256
...
docker buildx build \
  ...
  --build-arg "PRESERVED_SETTINGS_SHA256=${PRESERVED_SETTINGS_SHA256}" \
